<?php
	...
	if (isset($_POST['update_apartment'])) {
		...
		try {
			$stmt = $connect->prepare('UPDATE rental_registrations SET address = :address, rent = :rent, rooms = :rooms, deposit = :deposit, description = :description WHERE user_id = :user_id');
			...
			header('Location: update.php?action=update');
			exit;
		} catch (PDOException $e) {
			echo $e->getMessage();
		}
	...
	<div class="col-md-6 mx-auto">
		<div class="alert alert-info" role="alert">
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<button type="submit" class="btn btn-primary" name="update_apartment" value="update_apartment">Submit</button>
			</form>
		</div>
	</div>
</section>
